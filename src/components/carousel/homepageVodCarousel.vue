<template>
  <div class="w-100 carousel-main-height-wrapper">
    <div
    ...
    >
      <div class="row align-items-center mb-2">
        ...
        <div class="col-6">
          <!-- <div @click="viewMore()" class="d-flex justify-content-end">
        ...
        <div class="owl-carousel owl-theme" id="latestcarousel">
          ...
          >
            <vod-card
              ...
              :category="
                item_vod.data.content_type
                  ? item_vod.data.content_type[0].title.en_US
                  : ''
              "
            />
          </div>
...
@media only screen and (min-width: 992px) {
  #latestVODCarousel .owl-theme {
    height: 200px;
  }
}

#latestVODCarousel .owl-prev,
#latestVODCarousel .owl-next {
  max-height: 100px;
  top: 30px !important;
  width: 40px;
}
...
#latestVODCarousel .owl-prev span,
.owl-next span {
