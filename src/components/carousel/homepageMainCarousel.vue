              ...
              <div class="row h-100 align-items-center">
                <div class="col-8">
                  <div class="w-100 details-container d-flex flex-column">
                    <p class="main-title mb-1 mb-md-2">
                      <!-- <Trunquee :text="item_featured.data.title" :speed="120" /> -->
                      {{ truncateString(item_featured.data.title, 25) }}
                    </p>
                    <p class="desc mb-2 mb-md-4">
                      <span class="d-none d-md-block">{{
                        truncateString(item_featured.data.description, 200)
                      }}</span>
                      <span class="d-block d-md-none">{{
                        truncateString(item_featured.data.description, 80)
                      }}</span>
                    </p>
                    <div
                      class="custom-btn"
...
<style>
.masthead-content .owl-theme .owl-dots {
  position: absolute;
  bottom: 15%;
  left: 50%;
  transform: translateX(-50%);
}
.masthead-content .owl-theme .owl-dots .owl-dot span {
  width: 22px;
  height: 5px;
  margin: 5px;
  background: #869791;
}
.masthead-content .owl-theme .owl-dots .owl-dot.active span,
.masthead-content .owl-theme .owl-dots .owl-dot:hover span {
  background: #fab92b;
}

.masthead-content .owl-theme .custom-nav .owl-prev,
.masthead-content .owl-theme .custom-nav .owl-next {
  position: absolute;
  color: inherit;
...
.masthead-content .owl-theme .custom-nav .owl-prev .border-nav,
.masthead-content .owl-theme .custom-nav .owl-next .border-nav {
  width: 46px;
  height: 46px;
  border: 2px solid #ffffff;
  border-radius: 50%;
}
.masthead-content .owl-theme .custom-nav .owl-prev .border-nav i,
.masthead-content .owl-theme .custom-nav .owl-next .border-nav i {
  font-size: 2.4rem;
  color: #fab900;
  padding: 0 10px;
}
...
.masthead-content .owl-theme .owl-nav [class*='owl-']:hover {
